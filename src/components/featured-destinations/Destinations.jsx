    ...
    const destinations = [
        {
            ...
            excerpt: "A breathtaking white sandy beach, crystal-clear waters, and amazing resorts."
        },
        {
            index:2,
            ...
            excerpt: "Experience the Great Migration and spot the Big Five in this world-renowned park."
        },
        {
            index:3,
            ...
            title: "Mount Kenya",
            excerpt: "Perfect for hiking, with scenic landscapes and incredible biodiversity."
        },
        {
            index:4,
            ...
            title: "Lake Nakuru",
            excerpt: "Lake Nakuru National Park is a ball of beautiful sights waiting to be explored. A wide ecological diversity, varied wildlife habitats, plant and animal species"
        },
        {
            index:5,
            ...
            excerpt:"Nairobi National Park is home to diverse wildlife, including buffalo, giraffe, lions, leopards, baboons, zebras, wildebeest, and cheetahs" 
        },
        {
            index: 6,
            ...
            excerpt: "The Rwenzori are a range of mountains in eastern equatorial Africa, located on the border between Uganda and the Democratic Republic of the Congo"
        } 
    ];
